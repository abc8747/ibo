...
for counter, coordinate in enumerate(coords):
    ...
    for po in probeOffsets:
        data = json.loads(http.request("GET", f'https://api.hkmapservice.gov.hk/ags/gc/ib1000/buildings/building/reverseGeocode?key=584b2fa686f14ba283874318b3b8d6b0&outSR=%7B%22wkid%22:2326%7D&location=%7B%22x%22:{x+po[0]},%22y%22:{y+po[1]},%22spatialReference%22:%7B%22wkid%22:2326,%22latestWkid%22:2326%7D%7D&distance=100&f=json').data.decode("utf-8"))
        if "error" in data:
            continue
